--[[
ReaScript name: BuyOne_Move selected take FX up in the chain.lua
Author: BuyOne
...
About: 	The script first looks for a take under the mouse cursor,
	...
	After the selected FX has reached the top of the chain it will 
	not move in cycle back to its bottom.
	...
	The script along with 'BuyOne_Move selected take FX down in the chain.lua'
