...
Changelog:  v1.4 #Fixed individual script installation function
	    ...
	    v1.3 #Creation of individual scripts has been made hands-free. 
...
local scr_name = fullpath:match('.+[\\/].-_(.+)%.%w+') -- without path, scripter name and file ext
	...
	if not META_Spawn_Scripts(fullpath, fullpath_init, 'BuyOne_Move, select, im-, explode, crop overlapping items in lanes_META.lua', names_t)
