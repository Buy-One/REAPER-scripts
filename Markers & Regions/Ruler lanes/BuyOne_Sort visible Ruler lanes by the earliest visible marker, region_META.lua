--[[
ReaScript name: BuyOne_Sort visible Ruler lanes by the earliest visible marker, region_META.lua (2 scripts)
Author: BuyOne
...
--Msg(scr_name)
	...
	if not META_Spawn_Scripts(fullpath, fullpath_init, 'BuyOne_Sort visible Ruler lanes by the earliest visible marker, region_META.lua', names_t) -- names_t is optional only if constructed outside of the function, otherwise names are collected from the list in the header
