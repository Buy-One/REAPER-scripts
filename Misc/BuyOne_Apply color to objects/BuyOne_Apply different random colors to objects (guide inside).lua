...
About: 	The script is designed to be a one stop shop for object coloration
	...
	item selection, track selection. When one criterion is not met, the 
	next one is evaluated.  
	Thus first, objects within razor areas + time selection are targeted, 
	absent time selection objects within razor edit areas are targeted, 
	absent razor edit areas objects within time selection are targeted, 
	absent time selection selected items are targeted and absent selected 
	items selected tracks are targeted.
