...
Changelog:  1.5 #Made directory validation method cross-platform
			1.4 #Added support for retrieving original code from the clipboard
				#Updated 'About' text
...
-- field in their name, otherwise these will be colored
-- accordng to the USER_FUNCTION setting provided
-- the COLOR_USER_FUNCTIONS setting is enabled
COLOR_REAPER_LIB = "1"
