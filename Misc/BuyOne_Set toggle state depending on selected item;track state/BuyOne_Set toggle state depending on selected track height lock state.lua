--[[
ReaScript name: BuyOne_Set toggle state depending on selected track height lock state.lua
Author: BuyOne
...
r.SetToggleCommandState(sect_ID, cmd_ID, r.GetMediaTrackInfo_Value(sel_tr,'B_HEIGHTLOCK'))
