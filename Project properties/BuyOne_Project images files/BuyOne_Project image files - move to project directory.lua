--[[
ReaScript name: BuyOne_Project image files - move to project directory.lua
Author: BuyOne
...
-- natively when moving media via the 'Save As...'
...
-- if not enabled and an image file is also used as a video
-- take source, the original instance of the file will be
-- preserved while an item or track (if INCLUDE_TRACK_ICONS
-- setting is enabled below) will be associated with its copy
...
-- of a custom action:
--[[
BuyOne_Project image files - move to project directory.lua
File: Save project
--]]
