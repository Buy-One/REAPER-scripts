...
local scr_name = fullpath:match('[^\\/]-_(.+)%.lua') -- without path, scripter name & extxt

	-- doesn't run in non-META scripts
	if not META_Spawn_Scripts(fullpath, context[2], 'BuyOne_Save-Load window set #1-10 with Mixer scroll position_META.lua', names_t)
